...
// Import der benötigten Locales von date-fns
import { enUS } from "date-fns/locale/en-US";
import { de } from "date-fns/locale/de";

// Import des useTranslation Hooks von react-i18next
...
const Days: React.FC<{ currentDate: Date; events: Array<any> }> = ({
  ...
  // Verwendung des useTranslation Hooks, um die aktuelle Sprache zu erhalten
  const { i18n } = useTranslation();

  // Auswahl des passenden Locale-Objekts basierend auf der aktuellen Sprache
