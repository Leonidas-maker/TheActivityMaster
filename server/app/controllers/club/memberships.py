...
async def update_membership(
    ...
    if cancel_subscriptions:
        ...
        audit_log.membership_subscriptions_cancelled(user_id, club_id, canceled_subscriptions_ids, reason="Membership Update")
...
async def delete_membership(
    ...
    audit_log.membership_deleted(user_id, club_id, membership_id, f"Canceled {len(canceled_subscriptions)} subscriptions. See canceled subscriptions audit log for details.")
    audit_log.membership_subscriptions_cancelled(user_id, club_id, canceled_subscriptions_ids, reason="Membership Deletion")
...
async def create_membership_access(
    ...
    if await club_crud.any_membership_access_exists(db, membership_id, [access.program_id for access in new_membership_access]):
