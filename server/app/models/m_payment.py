...
class Transaction(Base):
    ...
    external_charge_id: Mapped[str] = mapped_column(String(255), nullable=False)  # z.B. Stripe charge ID
    user_id: Mapped[uuid.UUID] = mapped_column(UUID(as_uuid=True), ForeignKey("users.id"), nullable=False)

    amount: Mapped[DECIMAL] = mapped_column(DECIMAL(10, 2), nullable=False)
    amount_refunded: Mapped[DECIMAL] = mapped_column(DECIMAL(10, 2), nullable=False, default=0)
    ...
    payment_method: Mapped[PaymentMethod] = mapped_column(Enum(PaymentMethod), nullable=False, default=PaymentMethod.STRIPE)
    ...
    program_id: Mapped[uuid.UUID] = mapped_column(UUID(as_uuid=True), ForeignKey("programs.id"), nullable=True)
    membership_id: Mapped[uuid.UUID] = mapped_column(UUID(as_uuid=True), ForeignKey("memberships.id"), nullable=True)
...
class SplitTransaction(Base):
    ...
    external_transfer_id: Mapped[str] = mapped_column(String(255), nullable=False)  # z.B. Stripe transfer ID
